        ...
        card.innerHTML = `
          ...
          <div class="flex space-x-2">
            <a href="${item.product_url}" target="_blank" 
               class="flex-1 bg-red-100 text-red-600 py-2 rounded-lg hover:bg-red-200 transition-colors text-center">
               🛒Mua ngay
            </a>
...
document.addEventListener("DOMContentLoaded", () => loadProducts(["O009"]));
