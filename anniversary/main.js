      ...
      nextProducts.forEach((item) => {
        ...
        card.innerHTML = `
          ...
          <div class="flex items-center space-x-2 mb-4">
            <span class="text-purple-700 font-bold text-lg">${price.toLocaleString()}₫</span>
            <span class="text-gray-400 line-through">${(price + 20000).toLocaleString()}₫</span>
          </div>
          <div class="flex space-x-2">
            <a href="${item.product_url}" target="_blank" 
               class="flex-1 bg-purple-100 text-purple-600 py-2 rounded-lg hover:bg-purple-200 transition-colors text-center">
               🛒Mua ngay
            </a>
...
document.addEventListener("DOMContentLoaded", () => loadProducts(["O012","O013","O020","O021","O022","O023","O028"]));
